...
from train_test_class1 import train
from train_test_class1 import Encoder
from train_test_class1 import transform
import torch
...
async def incremental_train():
    ...
    if added_image_count > 0:
        try:
            model_path = r"D:\oil\best_class2.pth"
            ...
            print("开始重新训练模型...")
            dataset = datasets.ImageFolder(r"D:/oil/class1/train_data1", transform=transform)
